...
where (ce.TIME_REG BETWEEN TIMESTAMP '2021-08-14 00:00:00' AND TIMESTAMP '2021-08-15 00:00:00' AND
...
GROUP BY время_регистрации, idcall, активный_вызов_в_лпу, аон, дата_рождения, заявитель, место_работы, расшифровка_од,
         ...
         страший_оперотдела, подразделение, позывной_бр, активный_в_лпу, пол, список_состава, string_key