...
where (
          ce.TIME_REG BETWEEN TIMESTAMP '2023-01-01 00:00:00' AND TIMESTAMP '2023-01-18 00:00:00'
        ...
        --  AND pult_take_call.caption  = 'ОСМП КГБУЗ "Дальнереченская ЦГБ"'
        )